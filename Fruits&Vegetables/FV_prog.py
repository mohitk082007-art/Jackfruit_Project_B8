...
fruits = ['Watermelon', 'Chili pepper', 'Bellpepper', 'Banana', 'Grapes', 'Jalapeno', 'Kiwi', 'Lemon',
          'Mango', 'Orange', 'Paprika', 'Pear', 'Peas', 'Pineapple', 'Pomegranate', 'Sweetcorn', 'Apple',]
vegetables = ['Beetroot', 'Cabbage', 'Capsicum', 'Carrot', 'Cauliflower', 'Sweetpotato', 'Cucumber', 'Eggplant', 'Garlic', 'Ginger',
              'Lettuce', 'Onion',  'Potato', 'Raddish', 'Soya beans', 'Spinach', 'Corn', 'Tomato', 'Turnip']
